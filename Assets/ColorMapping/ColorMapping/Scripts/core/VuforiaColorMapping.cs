...
public class VuforiaColorMapping : MonoBehaviour
{
    ...
    {      
        ...
        {
            if (this.arContents.tag == "coloring")
            {
                drawObj = this.arContents;
            }
            else
            {
                foreach (Transform transform in this.arContents.transform)
                {
                    if (transform.tag == "coloring")
                    {
                        this.drawObj = transform.gameObject;
                        break;
                    }
                }
            }
